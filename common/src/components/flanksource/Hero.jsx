...
export function Hero({
  ...
  return (
    <div className={`relative isolate overflow-hidden bg-white hero-pattern ${className}`}>
      <div className="mx-auto max-w-7xl px-6 pb-24 sm:pb-32 lg:flex lg:px-8 lg:pb-40">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 pt-20 lg:pt-28">
          {logo && (
            <img
              className="h-11"
              src={logo}
