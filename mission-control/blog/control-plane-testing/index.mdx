---
title: Control Plane Testing With Canary Checker and Flux
description: Walkthrough of sythentic Infrastructure Testing for Kubernetes
slug: control-plane-testing-part1
authors: [moshe,yash]
...
1. Install the `canary-checker` binary
    ...
    :::info Operator Mode
    This tutorial uses the CLI for faster feedback, when rolling this out to production we recommend installing `canary-checker` as an [operator](/guide/canary-checker/getting-started)
