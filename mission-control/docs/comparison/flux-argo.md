...
Mission Control offers a [GitOps](/docs/guide/playbooks/actions/gitops) playbook action for creating new resources (e.g., Scaffolding) and updating existing files in Git repos via Pull Request. This can be used to update YAML files monitored by Flux/Argo or other files managed by Terraform, etc.
...
Mission Control offers enhanced health tracking using a combination of status, Lua, Go, and active/passive [health checks](/docs/guide/canary-checker/).
...
These combinations enable very fine-grained [notifications](/docs/guide/notifications) and filtering.
