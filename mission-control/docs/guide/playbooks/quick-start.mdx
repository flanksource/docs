...
1. Create a playbook spec
    ...
    See [Playbook](/docs/reference/playbooks) for the full specification.
...
3. Click **Run**<br/>
    ...
    > See [Event Triggers](/docs/guide/playbooks/events) to run the playbook on event (e.g. pod crashlooping) <br/>
    > See [Webhooks](/docs/guide/playbooks/webhooks) to run the playbook from a webhook (e.g. on Git push)
