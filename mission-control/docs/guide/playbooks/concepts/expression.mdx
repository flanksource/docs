...
| --- | --- | --- |
| `config` | Configuration object passed to the playbook | [`ConfigItem`](/docs/reference/config-db) |
| `check` | Canary Check object passed to the playbook | [`Check`](/docs/reference/canary-checker/check) |
