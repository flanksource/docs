...
| `if`                  | Whether to run the step or not                                                                                                                                                      | [`Expression`](../concepts/expression)               |          |
| `timeout`             | Timeout on this action.                                                                                                                                                             | `Duration`                                           |          |
| `retry`               | Retry the action when it fails.                                                                                                                                                     | [`Retry`](/docs/reference/playbooks#retry)           |          |
| `contentType`         | How the action's primary output is rendered on the UI.                                                                                                                              | `string`                                             |          |
| `ai`                  | Specify ai of action.                                                                                                                                                               | [AI](./ai)                                           |          |
| `azureDevopsPipeline` |                                                                                                                                                                                     | [AzureDevops](./azure_devops_pipeline)               |          |
| `catalog`             | Specify catalog of action.                                                                                                                                                          | [Catalog](./catalog)                                 |          |
| `exec`                | Specify exec of action.                                                                                                                                                             | [Exec](./exec)                                       |          |
| `github`              | Specify github of action.                                                                                                                                                           | [Github](./github)                                   |          |
| `gitops`              | Specify gitops of action.                                                                                                                                                           | [Gitops](./gitops)                                   |          |
| `http`                | Specify http of action.                                                                                                                                                             | [Http](./http)                                       |          |
| `logs`                | Specify logs of action.                                                                                                                                                             | [Logs](./logs)                                       |          |
| `notification`        | Specify notification of action.                                                                                                                                                     | [Notification](./notification)                       |          |
| `pod`                 | Specify pod of action.                                                                                                                                                              | [Pod](./pod)                                         |          |
| `prometheus`          | Specify a PromQL query to run.                                                                                                                                                      | [Prometheus](/docs/guide/views/queries/prometheus)   |          |
| `report`              | Specify report of action.                                                                                                                                                           | [Report](./report)                                   |          |
