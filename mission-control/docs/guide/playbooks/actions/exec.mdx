...
<!-- Source: modules/mission-control/api/v1/playbook_actions.go#ExecAction -->
...
<Fields rows={[
  ...
  {field: 'setup', scheme: '[Setup](#setup)', description: 'Install runtime dependencies (Bun, Python, PowerShell, Playwright) before execution'}
]}/>
...
<Fields rows={[
  ...
  },
  {
    ...
    scheme: "[OpenSearchConnection](/docs/reference/connections/opensearch)",
  },
  {
...
<Fields connection="git" oneOf={["connection", "url"]} rows={[
  {field: "connection", description: "Connection name to use for the git credentials", scheme: "string"},
  {field: "url", description: "URL of the git repository", scheme: "string"},
  {field: "username", description: "Username to authenticate with", scheme: "[EnvVar](/docs/reference/env-var)"},
  {field: "password", description: "Password or access token to authenticate with", scheme: "[EnvVar](/docs/reference/env-var)"},
  {field: "certificate", description: "SSH private key to authenticate with", scheme: "[EnvVar](/docs/reference/env-var)"},
...
<Fields rows={[
  ...
  {field: 'powershell', scheme: '[RuntimeSetup](#runtimesetup)', description: 'Install PowerShell'},
  {field: 'playwright', scheme: '[RuntimeSetup](#runtimesetup)', description: 'Install Playwright and its browsers'},
]}/>
