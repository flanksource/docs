...
Day 2 operations can be added onto existing resources (`configs`, `components` or health `checks`) using [resource selectors](/docs/reference/resource-selector).
...
Before running a playbook, users can provide input using [`parameters`](/docs/reference/playbooks/parameters).
...
The actions values can be templated using [Go Templates](/docs/reference/scripting/gotemplate)
...
The parameters to the playbooks are available in the [Context](/docs/reference/playbooks/context)
