...
5. Expand **Advanced settings** and enter `mc-cli` in **OAuth Client ID**.
6. Leave **OAuth Client Secret** empty unless your Mission Control deployment provides one.
7. Select **Add**.
8. On the **Connectors** page, select **Connect** for the Mission Control connector.
...
:::info
Use the access token as a bearer token: `Authorization: Bearer <token_value>`.
:::
...
2. **Authentication Failed**
   ...
   - Check if the Bearer prefix is included
