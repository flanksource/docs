...
<!-- Source: modules/config-db/api/v1/slack.go:5#Slack -->
...
| `slack`     | Specifies the list of Slack configurations to scrape.                        | [`[]Slack`](#slack-1)                              | `true`   |
...
<Custom rows={[
  ...
  },
  {
    ...
    scheme: "[MatchExpressions](/reference/types#matchexpressions)",
    required: false
  },
  {
    field: "rules",
...
<Custom rows={[
  ...
  },
  {
    ...
    scheme: "[[]ConfigItems](/guide/config-db/concepts/config-items)",
    required: true
  },
  {
    field: "mapping",
    description: "Mapping to transform extracted data into change fields",
    scheme: "[ChangeMapping](/guide/config-db/concepts/change-mapping)",
    required: false
  },
  {
    field: "filter",
...
<Custom rows={[
  {
    ...
    scheme: "[MatchExpression](/reference/types#matchexpression)",
    required: false
  },
  {
    field: "user",
  ...
  },
  {
    ...
    scheme: "[CelExpression](/reference/types#celexpression)",
    required: false
  }
]} />
