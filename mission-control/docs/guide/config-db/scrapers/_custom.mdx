...
See the [Custom Scraper](/docs/guide/config-db/scrapers/custom) page for the full output schema, shorthand keys, external entity schemas, and alias resolution.
