...
If SQL Server Audit is configured, scrape audit events. See [Access Logs](/docs/guide/config-db/concepts/access-logs) for more details on the access log schema.
