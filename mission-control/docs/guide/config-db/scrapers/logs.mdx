...
<Fields rows={[
  ...
  {
    field: "fieldMapping.host",
    description: "Source field names containing the host the log came from",
    scheme: "[]string"
  },
  {
    field: "fieldMapping.source",
    description: "Source field names containing the log source",
    scheme: "[]string"
  },
  {
    field: "fieldMapping.ignore",
    description: "Fields to drop from the log labels",
    scheme: "[]string"
  },
  {
    field: "fieldMapping.groupBy",
    description: "Fields to group the returned logs by",
    scheme: "[]string"
  },
  {
    field: "fieldMapping.dedupBy",
    description: "Fields to dedupe the returned logs by",
    scheme: "[]string"
  },
  {
    priority: 1,
    ...
    scheme: "[AzureLogAnalytics](#azureloganalytics)"
  },
  {
    priority: 1,
    field: "bigQuery",
...
<Fields rows={[
  ...
  {
    field: "start",
    description: "Start time for the query. Supports datemath e.g. `now-24h`",
    scheme: "string"
  },
  {
    field: "end",
...
<Fields rows={[
  {
    field: "workspaceID",
    description: "Azure Log Analytics workspace ID to query",
    scheme: "string",
    required: true
  },
  {
  ...
  {
    field: "connection",
    description: "Azure connection to use for credentials",
    scheme: "string"
  },
  {
    field: "clientID",
...
<Fields rows={[
  ...
  {
    field: "connection",
    description: "Connection name for OpenSearch credentials",
    scheme: "string"
  },
  {
    field: "index",
