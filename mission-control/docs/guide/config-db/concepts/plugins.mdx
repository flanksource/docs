...
<Fields
  rows={[
    ...
    },
    {
      ...
      scheme: '[Generate](/docs/reference/config-db/transformation#change-generation)'
    },
    {
      field: 'configs.mapping',
      description: 'Override fields on scraped config items',
      scheme: '[ConfigMapping](/docs/reference/config-db/transformation#config-mapping)'
    },
    {
      field: 'locations',
      description: 'Add location metadata for grouping',
      scheme: '[[]LocationOrAlias](/docs/reference/config-db/transformation#locations)'
    },
    {
      field: 'aliases',
      description: 'Add alternate identifiers used to look up config items',
      scheme: '[[]LocationOrAlias](/docs/reference/config-db/transformation#aliases)'
    },
    {
      field: 'retention',
...
<Fields
  rows={[
    ...
    {
      field: 'action',
      description: 'What action to take on the change. See [Change Mapping](/docs/reference/config-db/transformation#change-mapping)',
