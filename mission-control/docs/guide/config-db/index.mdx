...
* **Changes** recorded against config items either through automatic change detection (diffs) or from sources like [CloudTrail](/docs/guide/config-db/scrapers/aws#cloudtrail) or [Kubernetes Events](/docs/guide/config-db/scrapers/kubernetes#events)
