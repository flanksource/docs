...
| Field       | description                            |
| ----------- | -------------------------------------- |
| `git`       | [GitEnvVar](#git-env-vars)             |
| `kustomize` | [KustomizeEnvVar](#kustomize-env-vars) |

### Git Env Var

<Fields rows={[
  {field: "file", description: `Name of the file that created the config resource the playbook is run against. It is extracted from the \`config.kubernetes.io/origin\` annotation. The annotation
  ...
  {field: "url", description: "URL of the git repository", scheme: "string"},
  {field: "branch", description: "The primary branch", scheme: "string"},
]}/>
...
<Fields rows={[
  {field: "path", description: "Path of the kustomization file that created the config resource the playbook is run against. This comes from the spec of the kustomization.", scheme: "string"},
]}/>
