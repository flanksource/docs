...
```yaml title="exec-artifact.yaml" file=../../../modules/mission-control/fixtures/playbooks/exec-artifact.yaml
...
### Git Checkout
```yaml title="exec-checkout.yaml" file=../../../modules/mission-control/fixtures/playbooks/exec-checkout.yaml
```
