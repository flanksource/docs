...
Mission Control integrates with Microsoft Teams to send notifications to channels. Use it to:
...
<Cards>
  <Card title="Notification Reference" href="/docs/guide/notifications">
