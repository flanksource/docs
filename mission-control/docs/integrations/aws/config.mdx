...
<Cards>
  <Card title="AWS Integration" href="/docs/integrations/aws">
    Learn about AWS resource scraping
  </Card>
  <Card title="Health Check Reference" href="/canary-checker/docs/reference/aws-config">
    AWS Config health check configuration options
  </Card>
</Cards>
