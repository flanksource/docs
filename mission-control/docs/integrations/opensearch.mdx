...
Mission Control integrates with Opensearch and Elasticsearch to monitor your search infrastructure. Use it to:
...
<Cards>
  <Card title="Health Check Reference" href="/canary-checker/docs/reference/opensearch">
    Opensearch health check configuration options
  </Card>
  <Card title="Elasticsearch Reference" href="/canary-checker/docs/reference/elasticsearch">
    Elasticsearch health check configuration options
  </Card>
</Cards>
