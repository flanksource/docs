...
Mission Control provides an MCP (Model Context Protocol) server that enables AI assistants like Claude to interact with your infrastructure. Use it to:
...
<Cards>
  <Card title="Playbooks" href="/docs/guide/playbooks">
    Learn about automating operations with playbooks
  </Card>
  <Card title="Config DB" href="/docs/guide/config-db">
