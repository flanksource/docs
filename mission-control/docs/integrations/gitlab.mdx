...
Mission Control integrates with GitLab for GitOps workflows and repository operations. Use it to:
...
<Cards>
  ...
  <Card title="GitOps Actions" href="/docs/guide/playbooks/actions/gitops">
