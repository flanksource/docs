...
Mission Control integrates with Kustomize to simplify configuration management. Use it to:
...
<Cards>
  ...
  <Card title="Helm Integration" href="/docs/integrations/helm">
    Deploy Helm charts alongside Kustomize resources
  </Card>
  <Card title="Playbook Actions" href="/docs/guide/playbooks/actions/gitops">
