...
Mission Control integrates with Google Cloud Platform to provide visibility into your cloud infrastructure. Use it to:
...
<Cards>
    <Card size="sm" title="ScrapeConfig" icon="k8s-customresourcedefinition" link="/docs/guide/config-db/scrapers/gcp">
      <Tag label="CRD"/>
  </Card>

  <Card size="sm" title="GCP Cloud Storage" icon="google-cloud-storage" link="/docs/guide/canary-checker/reference/folder">
