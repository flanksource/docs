...
- Ingest cost data from the [Cloud Billing export](/docs/guide/config-db/scrapers/gcp#cost-reporting) in BigQuery
- Ingest [audit logs](/docs/guide/config-db/scrapers/gcp#audit-logs) and IAM policy bindings as access records
