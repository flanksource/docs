...
Mission Control integrates with LDAP directories to monitor authentication infrastructure. Use it to:
...
<Cards>
  <Card title="Health Check Reference" href="/canary-checker/docs/reference/ldap">
    LDAP health check configuration options
  </Card>
  <Card title="Azure AD Integration" href="/docs/integrations/azure-ad">
