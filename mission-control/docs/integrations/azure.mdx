...
Microsoft Azure is a cloud platform offering over 200 services across compute, storage, networking, databases, and more. Mission Control integrates with Azure to discover and catalog your cloud resources, tracking configuration changes and relationships across subscriptions and resource groups.
