...
Slack is a business messaging platform that organizes team communication into channels and supports rich integrations with developer tools and services. Mission Control integrates with Slack to send alert notifications to channels and scrape workspace data into the catalog.
