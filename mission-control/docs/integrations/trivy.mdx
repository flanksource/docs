...
Mission Control integrates with Trivy to scan your Kubernetes clusters for security issues. Use it to:
...
<Cards>
  <Card title="Scraper Reference" href="/docs/guide/config-db/scrapers/trivy">
