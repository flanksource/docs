...
| [<Icon name="k8s-customresourcedefinition">PermissionGroups</Icon>](/docs/guide/permission#permission-groups)                                                                         | Group subjects (people, teams, or system services) under one name for simpler permission setup                           | Create permissions for group         |
