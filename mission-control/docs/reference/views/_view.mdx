<Fields rows={[
  ...
  },
  {
    ...
    scheme: "[[]ViewVariable](/docs/guide/views/concepts/templating)"
  },
  {
    field: "sections",
  ...
  {
    field: "pdf",
    description: "Rendering options used when the view is exported to PDF or HTML through a facet server",
    scheme: "[Facet](/docs/guide/playbooks/actions/report#facet)"
  },
  {
    field: "mcp",
    description: "How this view is presented to LLM clients as an [MCP](/docs/guide/mcp) tool",
    scheme: "[MCP](/docs/reference/playbooks#mcp)"
  }
]}/>
...
- **Column definition**: When using Prometheus or HTTP queries, `columns` map must be defined to generate the table schema
:::
...
<Fields rows={[
  ...
  },
  {
    ...
    scheme: "[SQL query](/docs/guide/views/queries/sql)"
  },
  {
    field: "http",
...
<Fields rows={[
  ...
  },
  {
    ...
    scheme: "`string`, `number`, `boolean`, `datetime`, `duration`, `health`, `status`, `gauge`, `bytes`, `decimal`, `millicore`, `config_item`, `labels`"
  },
  {
    field: "primaryKey",
  ...
  {
    field: "width",
    description: "Display width of the column, e.g. `150px` or a flex weight like `2`",
    scheme: "string"
  },
  {
    field: "description",
  ...
  {
    field: "badge",
    description: "Badge styling configuration for the column",
    scheme: "[BadgeConfig](#badge-configuration)"
  },
  {
    field: "unit",
...
<Fields rows={[
  ...
  {
    field: "thresholds[].percent",
    description: "Threshold as a percentage of the gauge range (0–100)",
    scheme: "int"
  },
  {
...
`display.card` controls the default card layout for the view (when `default: true`, cards are shown instead of the table).
...
`columns[].badge` controls the styling of badge/tag values.

<Fields rows={[
  {
    field: "color.auto",
    description: "Use heuristics to choose a color based on the cell value",
    scheme: "bool"
  },
  {
    field: "color.map",
    description: "Explicit value-to-color mapping, e.g. `Running: green`",
    scheme: "map[string]string"
  }
]}/>
...
<Fields rows={[
  ...
  {
    field: "viewRef.name",
    description: "Name of the view to include",
    scheme: "string"
  },
  {
    field: "viewRef.namespace",
    description: "Namespace of the view to include",
    scheme: "string"
  },
  {
    field: "uiRef.changes",
    description: "Embed the native Changes UI component",
    scheme: "[ChangesUIFilters](#changes-ui-filters)"
  },
  {
    field: "uiRef.configs",
    description: "Embed the native Configs UI component",
    scheme: "[ConfigsUIFilters](#configs-ui-filters)"
  }
]}/>
...
<Fields rows={[
  {
    field: "configTypes",
    description: "Filter by config types (comma-separated)",
    scheme: "string"
  },
  {
    field: "changeType",
  ...
  {
    field: "from",
    description: "Start time (duration string, e.g. 24h)",
    scheme: "string"
  },
  {
    field: "tags",
    description: "Filter by tags (Kubernetes style selector)",
    scheme: "string"
  }
]}/>
...
<Fields rows={[
  ...
  {
    field: "labels",
    description: "Filter by labels (Kubernetes style selector)",
    scheme: "string"
  },
  {
    field: "status",
