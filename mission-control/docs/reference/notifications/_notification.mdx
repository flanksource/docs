...
<Fields withTemplates="true" rows={[
  ...
  },
  {
    ...
    scheme: "GoTemplate",
    templateEnv: [
      {"name": "CheckEvents", "url": "/docs/reference/notifications/template_vars#check-health-env"},
      {"name": "ConfigEvents", "url": "/docs/reference/notifications/template_vars#config-health-env"},
      {"name": "ComponentEvents", "url": "/docs/reference/notifications/template_vars#component-health-env"},
    ],
  },
  {
    field: "template",
