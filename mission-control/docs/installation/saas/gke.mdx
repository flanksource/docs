...
<Cards className="border border-t border-solid border-gray-200">
  ...
  <Card size="sm" title="Scrape GCP Resources" icon="gcp" link="/integrations/gcp/getting-started">
          <Tag label="Integration"/>
  </Card>

  <Card size="sm" title="Scraper" icon="gcp" link="/guide/config-db/scrapers/gcp">
          <Tag label="CRD"/>
  </Card>
