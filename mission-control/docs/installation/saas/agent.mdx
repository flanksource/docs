...
2. Click on the <Icon name="plus"/> button, and enter in the dialog:
    * **clusterName**
    * Toggle **Kubernetes** to automatically scrape the cluster the agent is installed in, you can skip this step and perform it later by installing the [chart](/docs/integrations/kubernetes/getting-started)
    <p/>
3. Click **Next**
