...
<Cards className="border border-t border-solid border-gray-200">
  ...
  <Card size="sm" title="Scrape AWS Resources" icon="aws" link="/docs/integrations/aws/getting-started">
          <Tag label="Integration"/>
  </Card>

  <Card size="sm" title="Scraper" icon="k8s-customresourcedefinition" link="/docs/guide/config-db/scrapers/aws">
          <Tag label="CRD"/>
  </Card>
