...
Some checks like [Kubernetes Resource](/docs/guide/canary-checker/reference/kubernetes-resource) and [HTTP](/docs/guide/canary-checker/reference/http) expose additional metrics.
