...
| **Connection** |                                                                                                                                        |                                                         |          |
| `connection`   | Path of existing connection e.g. `connection://postgres/instance` Mutually exclusive with `username`, `password` <br /> <Commercial /> | <CommonLink to="connections" >_Connection_</CommonLink> |          |
...
| ------- | ----------------------- | --------------------------- |
| `rows`  |                         | _[]map[string]interface{}_ |
| `count` | Number of rows returned | _int_                       |
