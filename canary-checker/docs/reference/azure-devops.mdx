...
| `personalAccessToken` | <SkipOSS>Mutually exclusive with `connection`</SkipOSS>  , See [Creating ADO PAT's](https://learn.microsoft.com/en-us/azure/devops/organizations/accounts/use-personal-access-tokens-to-authenticate?view=azure-devops&tabs=Windows) | <CommonLink to="authentication" anchor="envvar">*EnvVar*</CommonLink> | true     |
