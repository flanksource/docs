...
<!-- Source: modules/canary-checker/api/v1/checks.go:639#NamespaceCheck -->
...
```yaml title='namespace-check.yaml' file=<rootDir>/modules/canary-checker/fixtures/k8s/slow/namespace_pass.yaml
```
