...
<details summary="Create an S3 bucket with Crossplane and test if uploads work using S3 check">
<div>

```yaml title="namespace_creation.yaml" file=../../../modules/canary-checker/fixtures/external/TODO
