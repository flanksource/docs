...
<HealthCheck name="databaseBackup" edition="standard" rows={[
  {field: "maxAge", description: "Max age for backup allowed", scheme: "Duration", required: true},
  ...
  {field: "gcp.gcpConnection", description: "GCP connection credentials", scheme: "GCPConnection"}
]}/>
