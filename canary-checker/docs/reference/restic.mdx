...
| `password`        | <SkipOSS>Mutually exclusive with `connection`</SkipOSS>                           | <CommonLink to="authentication" anchor="envvar">*EnvVar*</CommonLink> | Yes      |
| **AWS Connection** |  |  |          |
...
| `accessKey`       | Mutually exclusive with `awsConnectionName`                  | <CommonLink to="authentication" anchor="envvar">*EnvVar*</CommonLink> | Yes      |
| `secretKey`       | Mutually exclusive with `awsConnectionName`                  | <CommonLink to="authentication" anchor="envvar">*EnvVar*</CommonLink> | Yes      |
