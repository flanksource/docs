...
| **Connection** |  |  | |
| `connection` | Path of existing connection e.g. `connection://alertmanager/instance`/ Mutually exclusive with `username`, `password`, `url`  <br /> <Commercial /> | <CommonLink to="connections" >*Connection*</CommonLink> | |
