...
|               |                                                                                                                             |                                                         |          |
| `connection`  | Path of existing connection e.g. `connection://prometheus/instance`<br />Mutually exclusive with `url` <br /><Commercial /> | <CommonLink to="connections" >_Connection_</CommonLink> |          |
