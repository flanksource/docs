...
| --------- | ----------------------------------------------------------- | ---------------------------------------------------- | -------- |
| `maxAge`  | MaxAge the latest object should be younger than defined age | [Duration](/reference/common-types#Duration)                          |          |
| `maxSize` | MaxSize of the files inside the searchPath                  | [Size](/reference/common-types#Size)                                     |          |
| `minAge`  | MinAge the latest object should be older than defined age   | [Duration](/reference/common-types#Duration)                           |          |
| `minSize` | MinSize of the files inside the searchPath                  | [Size](/reference/common-types#Size)                                        |          |
