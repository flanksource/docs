...
| Field                            | Description                                                                       | Scheme                                                                     | Required |
| -------------------------------- | --------------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------- |
| <SkipOSS>`connection<`</SkipOSS> | <SkipOSS> Path of existing connection e.g. `connection://aws/instance` </SkipOSS> | <SkipOSS><CommonLink to="connection">_Connections_</CommonLink> </SkipOSS> |          |
| endpoint                         | GCP Endpoint                                                                      | _string_                                                                   | Yes      |
| credentials                      | Credentials                                                                       | <CommonLink to="secrets" >_Secrets_</CommonLink>                           | Yes      |
