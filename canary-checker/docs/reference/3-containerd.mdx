...
```yaml file=../../../modules/canary-checker/fixtures/minimal/containerd-pull.yaml title='containerd-pull.yaml'
```
...
```yaml file=../../../modules/canary-checker/fixtures/minimal/containerd-push.yaml title='containerd-push.yaml'
```
