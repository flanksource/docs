...
| **Connection** |  |  | |
| `connection` | Path of existing connection e.g. `connection://mssql/instance`/ Mutually exclusive with `username`, `password` <br /> <Commercial /> | <CommonLink to="connections" >*Connection*</CommonLink> | |
